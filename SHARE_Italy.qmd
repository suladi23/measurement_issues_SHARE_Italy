...
We can see that for our contry of references we find a gini coefficient equal to 0.334, which indicates some ineqaulity but not that much.

We now need to consider other coefficients:
