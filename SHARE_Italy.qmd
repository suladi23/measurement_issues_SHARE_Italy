...
Börsch-Supan, A. & S. Gruber (2020): *easySHARE. Release version: 8.0.0. SHARE-ERIC. Dataset.* doi: [10.6103/SHARE.easy.800](http://dx.doi.org/10.6103/SHARE.easy.800) Istat 2018, *Condizione di vita, reddito e carico fiscale delle famiglie* Asada, Y., Hurley, J., Norheim, O.F. et al. *A three-stage approach to measuring health inequalities and inequities*. Int J Equity Health 13, 98 (2014). https://doi.org/10.1186/s12939-014-0098-y
...
This result for Italy, a Palma ratio of approximately 0.65, means that the income share of the top 10% of the population is about 0.65 times larger than the income share of the bottom 40%. It suggests that a signifiant portion of the total income is concentrated among the wealthiest individuals, something that is not surprising in developed countries like Italy.
...
health_disparity_gender_chronic <- female_mean_chronic / male_mean_chronic

# Print the health disparity index
print(paste("Health disparity per gender in self reported health:", round(health_disparity_gender_sphus * 100, 2), "%"))

print(paste("Health disparity per gender in ADL:", round(health_disparity_gender_adla * 100, 2), "%"))

print(paste("Health disparity per gender in chronic disease:", round(health_disparity_gender_chronic * 100, 2), "%"))
```
